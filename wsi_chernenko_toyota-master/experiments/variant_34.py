...
The pipeline system performs the 34th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
if __name__ == "__main__":
    ...
    clusters = cos_sim_clustering(cos_sim_vocab, path+"/output_34.txt")
    print("Done.")
