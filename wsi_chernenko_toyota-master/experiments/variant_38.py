...
The pipeline system performs the 38th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_38.txt", 7)
    print("Done.")
