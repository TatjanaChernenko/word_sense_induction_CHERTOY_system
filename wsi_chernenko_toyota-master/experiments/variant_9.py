...
The pipeline system performs the 9th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- For pre-rpocessing: tokenization + punctuation removal + english stopwords removal
...
average Rand Index = 0.390959595959596

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.022434416740284572

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.18760489470112685
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_9.txt", 7)
    print("Done.")
