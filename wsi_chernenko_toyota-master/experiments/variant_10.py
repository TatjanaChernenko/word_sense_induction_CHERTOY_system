...
The pipeline system performs the 10th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- For pre-rpocessing: tokenization + punctuation removal + stemming
...
average F1 = 0.672984391206456

=========== Final average value of Rand Index: =============
average Rand Index = 0.3937373737373737

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.03217332101682315

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.1877390534702881
    ...
    for value in text.values():
        for paragr in value:
            for i in range(1,len(paragr)): 
                ...
                without_stopwords = [porter.stem(t) for t in str(paragr[i]) if t.split()]
                paragr[i] = without_stopwords
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_10.txt", 7)
    print("Done.")
