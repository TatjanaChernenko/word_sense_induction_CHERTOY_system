...
The pipeline system performs the 3rd variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.4726262626262626

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.05042204500203959

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.3317203965285945
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_3.txt", 3)
    print("Done.")
