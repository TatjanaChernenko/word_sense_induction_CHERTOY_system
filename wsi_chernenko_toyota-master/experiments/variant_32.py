...
The pipeline system performs the 32th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.4166666666666667

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.02376688846801957

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.24580958866306932
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_32.txt", 7)
    print("Done.")
