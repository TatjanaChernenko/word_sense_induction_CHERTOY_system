...
The pipeline system performs the 4th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.4156565656565656

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.03032568439434647

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.2346876236881725
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_4.txt", 5)
    print("Done.")
