...
The pipeline system performs the 22th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Clustering: Cos similarity with max Similarity and similarity factor = min 0.4

------------------- EVALUATION -------------------

=========== Final average value of F1: =====================
average F1 = 0.6315221034842844

=========== Final average value of Rand Index: =============
average Rand Index = 0.48484848484848486

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = -5.948446232646315E-4

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.41884778049529237

================ Statistics: ====================================
============ average number of created clusters: 3.0
============ average cluster size: 31.3125
...
#LIKE WSD: Cluster sentences (snippets) based on cos similarity to Subtopics with sim_factor= > as 0.4; create an output file:
def cos_sim_clustering(cos_sim_vocab, output, sim_factor):
    f = open(output, "a")
...
if __name__ == "__main__":
    ...
    clusters = cos_sim_clustering(cos_sim_vocab, path+"/output_22.txt", 0.4)
    print("Done.")
