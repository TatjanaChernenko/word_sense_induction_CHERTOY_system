...
The pipeline system performs the 35th variant of the pipeline for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average F1 = 0.6678536961579072

=========== Final average value of Rand Index: =============
average Rand Index = 0.407070707070707

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = -0.004035733787080787

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.24275380463485002

================ Statistics: ====================================
============ average number of created clusters: 6.75
============ average cluster size: 18.369444444444447
...
if __name__ == "__main__":
    ...
    compos_subtopics_vectors = compose_sent2vec_subtopics(subtopics_vectors, 700)
    cos_sim_vocab = cos_sim_vocab(compos_subtopics_vectors, compos_vectors)
    clusters = cos_sim_clustering(cos_sim_vocab, path+"/output_35.txt")
    print("Done.")
