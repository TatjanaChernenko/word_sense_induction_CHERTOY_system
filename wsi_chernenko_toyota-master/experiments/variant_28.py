...
The pipeline system performs the 28th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Language model: sentvec, wiki_unigrams - pretrained Model 
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_28.txt", subtopics)
    print("Done.")
