...
The pipeline system performs the 40th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.6093434343434344

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = -0.04728805820259084

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.5901281345084848

================ Statistics: ====================================
============ average number of created clusters: 7.5
============ average cluster size: 13.80952380952381
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_40.txt", 7)
    print("Done.")
