...
The pipeline system performs the first variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average F1 = 0.6803248184458212

=========== Final average value of Rand Index: =============
average Rand Index = 0.38863636363636367

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.032693820828527106

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.19441000149826304
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_1.txt", subtopics)
    print("Done.")
