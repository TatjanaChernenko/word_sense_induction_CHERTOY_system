...
The pipeline system performs the 15th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average F1 = 0.6753976572391646

=========== Final average value of Rand Index: =============
average Rand Index = 0.3842424242424243

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.013787573831008258

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.17889714706694396
            ...
            for i in range(1,len(paragr)): 
                ...
                for word in tokens:
                    if word == "n": 
                        ...
                        words.append(word.lower().strip()) # delete first empty placeholder + remove capitalization
                paragr[i] = words  
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_15.txt", 7)
    print("Done.")
