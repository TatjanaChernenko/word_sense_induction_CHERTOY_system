...
The pipeline system performs the 24th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Language model: sent2vec (paper: https://arxiv.org/abs/1511.06388, code: https://github.com/explosion/sense2vec), words
...
average Rand Index = 0.6129292929292929

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = -0.03583758440065399

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.6004415783266719

================ Statistics: ====================================
============ average number of created clusters: 7.0
============ average cluster size: 14.43452380952381
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_24.txt", 7)
    print("Done.")
