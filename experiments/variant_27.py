...
The pipeline system performs the 27th variant of the pipeline for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Language model: sentvec, wiki_bigrams - pretrained Model 
...
average Rand Index = 0.3912626262626263

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.019149605135557943

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.22206469591413686
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_27.txt", subtopics)
    print("Done.")
