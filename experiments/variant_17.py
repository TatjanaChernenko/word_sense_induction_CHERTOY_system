...
average F1 = 0.6832306169827408

=========== Final average value of Rand Index: =============
average Rand Index = 0.6823232323232323

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.1538335320764806

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.62490678553692

================ Statistics: ====================================
============ average number of created clusters: 7.0
============ average cluster size: 14.821428571428571
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_17.txt")
    print("Done.")
