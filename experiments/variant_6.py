...
The pipeline system performs the 6th variant of the baseline for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average F1 = 0.7000513107020329

=========== Final average value of Rand Index: =============
average Rand Index = 0.34984848484848485

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.019472334671121475

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.08909617447932518

================ Statistics: ====================================
============ average number of created clusters: 20.0
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_6.txt", 20)
    print("Done.")
