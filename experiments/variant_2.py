...
The pipeline system performs the 2nd variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.6928282828282828

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.0

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.6928282828282828

================ Statistics: ====================================
============ average number of created clusters: 1.0
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_2.txt", 1)
    print("Done.")
