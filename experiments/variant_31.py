...
The pipeline system performs the 31th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average F1 = 0.6703023416721151

=========== Final average value of Rand Index: =============
average Rand Index = 0.4102020202020202

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.005737790436395889

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.21659099096192647
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_31.txt", 7)
    print("Done.")
