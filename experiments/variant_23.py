...
The pipeline system performs the 23th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Clustering: Cos similarity with max Similarity and similarity factor = min 0.3

------------------- EVALUATION -------------------

=========== Final average value of F1: =====================
average F1 = 0.661352605692281

=========== Final average value of Rand Index: =============
average Rand Index = 0.5308585858585859

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = -0.008580727471213764

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.48613258337276766

================ Statistics: ====================================
============ average number of created clusters: 3.25
============ average cluster size: 33.208333333333336
...
if __name__ == "__main__":
    ...
    clusters = cos_sim_clustering(cos_sim_vocab, path+"/output_23.txt", 0.3)
    print("Done.")
