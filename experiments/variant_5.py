...
The pipeline system performs the 5th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Adj Rand Index = 0.021385128391207205

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.18536176710073987
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_5.txt", 7)
    print("Done.")
