...
The pipeline system performs the 8th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
average Rand Index = 0.4036363636363637

=========== Final average value of Adjusted Rand Index: ====
average Adj Rand Index = 0.03839136624518455

=========== Final average value of Jaccard Index: ==========
average Jaccard Index = 0.19408957123620182
