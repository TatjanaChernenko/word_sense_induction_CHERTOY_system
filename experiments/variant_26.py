...
The pipeline system performs the 26th variant of the system for WSI (word sense induction) task (the Task 11 at SemEval 2013).
...
- Language model: sentvec, plaintexts_bigramm - trained Model (Wikipedia 2017)
...
if __name__ == "__main__":
    ...
    clusters = cluster(compos_vectors, path+"/output_26.txt", subtopics)
    print("Done.")
